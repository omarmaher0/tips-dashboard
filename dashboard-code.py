...
cat_filter = st.sidebar.selectbox('Categorical Filering',[None,'sex','smoker','day','time'])
...
st.sidebar.markdown('Made with 🐯 by Eng. [Omar Maher](https://www.youtube.com/@brefat)')

#---------Body of page----------

#-------First row-------
#-------create 4 metric-------
#------Make metrics as columns to be in horizontal view-------
...
#------Third row-------
#------create 3 charts(bar-pie-donut)-------
#----(4,3,3) these numbers means size of charts----
